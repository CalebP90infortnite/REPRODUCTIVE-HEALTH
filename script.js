...
let friends = JSON.parse(localStorage.getItem("bloom-friends") || '["Maya","Jay","Noa"]');
...
function currentQuestions() {
  return questionBank[activeTier];
}
...
function nextQuestion() {
  ...
  feedback.textContent = `Round complete, ${username}! ${activeTier.toUpperCase()} score: ${score}. New round starts now.`;
